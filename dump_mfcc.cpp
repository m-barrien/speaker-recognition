...
static int frames_to_process = 3000;
...
int main() {
  ...
  std::cout << runtime << " segundos para procesar 3000 frames de audio o " << 3000 * RAW_PERIOD_SAMPLE_SIZE/SAMPLES_PER_SECOND << " segundos de audio real" <<std::endl;
  return 0;
}
